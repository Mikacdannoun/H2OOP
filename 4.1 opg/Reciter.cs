...
public class Reciter
{
    ...
    public static void ReciteAllTheWords()
    {
        ...
        //The WriteLine in program.cs was written before any recited numbers, so i use await here in ReciteAllTheWords
        //In order to make program.cs wait until all numbers have been recited to write in the console
