...
//BetterObjectComparer for dog
BetterObjectComparer<Dog> dogComparer = new BetterObjectComparer<Dog>();
Dog largestDog = dogComparer.Largest(dog1, dog2, dog3);
Console.WriteLine("Largest Dog " + largestDog);

//BetterObjectComparer for circle
BetterObjectComparer<Circle> circleComparer = new BetterObjectComparer<Circle>();
Circle largestCircle = circleComparer.Largest(c1, c2, c3);
Console.WriteLine("Largest Circle " + largestCircle);
